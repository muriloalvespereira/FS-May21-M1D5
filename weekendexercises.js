...
let test = "firstexercise"

/* Ex.B
    Create a variable called "sum" and assign to it the result of the sum between 10 and 20.
*/
let sumTwoNumbers = 10+20
...
*/
me.skills = skills = ["JavaScript", "HTML", "CSS"];
console.log(me)
/* Ex.G 
   Programmatically remove the last skill from the "skills" array inside the "me" object.
*/
delete me.skills[2]
let filtered = me.skills.filter(function (el) {
    return el != null;
  });
...
function deleteOne(str, boolean){
    if(boolean === true){
      let strDelete = str.split("");
      delete strDelete.shift();
      return strDelete.join("") 
    } else{
      let strDelete = str.split("");
      delete strDelete.pop();
      return strDelete.join("")  
    }
...
*/
function onlyLetters(strExe5){
    let withNoDigits = strExe5.replace(/[0-9]/g, '');
    return withNoDigits
}   
console.log(onlyLetters("My name is Murilo and I am 33 years old"))
...
*/
function rollTheDices(rtd){
    let sum1 = 0;
    let arrayOne = [];
    for (let i = 0; i < rtd; i++){
        let arrayOfNumbers = dice(1,10);
        arrayOne.push(arrayOfNumbers);
        sum1 += arrayOfNumbers
    } 
    return console.log(`${arrayOne} Sum: ${sum1}`)
}
rollTheDices(7);
...
let exer11Two = "surname"
function deleteProp(objOne, surname){
    delete objOne.surname
    return console.log(objOne)
}
deleteProp(exer11, exer11Two);
/* Ex.12 
