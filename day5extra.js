...
*/
let shoppingCart = [
    {id:"1232501", name:"bread", price: 5, toBeShipped: 3},
    {id:"1232502", name:"butter", price: 3, toBeShipped: 1},
    {id:"1232503", name:"ham", price: 8, toBeShipped: 7},
    {id:"1232504", name:"cheese", price: 5, toBeShipped: 6}
]
let some = 0
let shipped = []
let shippingCartTotal = function(){
    for(let i=0; i<shoppingCart.length; i++){
        shipped.push(shoppingCart[i].toBeShipped)
    }
